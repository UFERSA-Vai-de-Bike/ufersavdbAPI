...
function getBikes(req, res, next) {
  return db
    .func("getBikes", undefined, queryResult.any)
    .then(function(data) {
      res.status(200).json(response.success(data, "Retornou todas as bikes"));
    })
    .catch(function(err) {
...
function getOnRideBikes(req, res, next) {
  return db
    .func("getOnRideBikes", undefined, queryResult.any)
    .then(function(data) {
      res
        .status(200)
...
function getBikesName(req, res, next) {
  return db
    .func("getBksName", undefined, queryResult.any)
    .then(function(data) {
      res
        .status(200)
...
function getValBks(req, res, next) {
  return db
    .func("getOpBikes", undefined, queryResult.any)
    .then(function(data) {
      res
        .status(200)
        .json(
          response.success(data, "Retornou o ID e o nome de bicicletas válidas")
        );
    })
    .catch(function(err) {
      res.status(500).json(response.failure(err));
...
function getBike(req, res, next) {
  ...
  return db
    .func("getBike", bkID, queryResult.one)
    .then(function(data) {
      res.status(200).json(response.success(data, "Retornou uma bike"));
    })
    .catch(function(err) {
      res.status(500).json(response.failure(err));
    });
...
function getBikesSt(req, res, next) {
  return db
    .func("getBikesSt", parseInt(req.params.id), queryResult.any)
    .then(function(data) {
      res
        .status(200)
...
function getBikesOnSt(req, res, next) {
  return db
    .func("getBikesOnSt", parseInt(req.params.id), queryResult.any)
    .then(function(data) {
      res
        .status(200)
        .json(
          response.success(data, "Retornou todas as bikes que estão na estação")
        );
    })
    .catch(function(err) {
      res.status(500).json(response.failure(err));
...
function getBikesOffSt(req, res, next) {
  return db
    .func("getBikesOffSt", parseInt(req.params.id), queryResult.any)
    .then(function(data) {
      res
        .status(200)
        .json(
          response.success(
            data,
            "Retornou todas as bikes que sairam da estação"
          )
        );
    })
    .catch(function(err) {
...
function getLogs(req, res, next) {
  return db
    .func("getHistsBike", null, queryResult.any)
    .then(function(data) {
      res
        .status(200)
...
function getLog(req, res, next) {
  var bkID = parseInt(req.params.id);
  return db
    .func("getHistBike", [bkID, null], queryResult.any)
    .then(function(data) {
      res
        .status(200)
...
function createBike(req, res, next) {
  return db
    .func("createBike", req.body.name, queryResult.one)
    .then(function() {
...
function updateBike(req, res, next) {
  return db
    .func(
      "upd_bike",
      [parseInt(req.body.idbike), req.body.name, req.body.state],
      queryResult.any
    )
    .then(function() {
...
function updateStation(req, res, next) {
  return db
    .func(
      "upd_bikeSt",
      [
        parseInt(req.params.bk),
        parseInt(req.params.st),
        parseInt(req.params.sl)
      ],
      queryResult.one
    )
    .then(function() {
      res
        .status(200)
        .json(response.success({}, "Atualizou a estação de uma bike"));
    })
    .catch(function(err) {
      res.status(500).json(response.failure(err));
    });
...
function removeBike(req, res, next) {
  var bkID = parseInt(req.params.id);
  return db
    .func("delBike", bkID, queryResult.one)
...
function removeBikes(req, res, next) {
  return db
    .func("delBikes", undefined, queryResult.one)
    .then(function(result) {
      res
        .status(200)
        .json(response.success({}, "Removeu " + result.rowCount + " bikes"));
    })
    .catch(function(err) {
      res.status(500).json(response.failure(err));
    });
...
function changeState(req, res, next) {
  var bkID = parseInt(req.params.id);
  return db
    .func("changeBikeState", bkID, queryResult.one)
    .then(function(result) {
