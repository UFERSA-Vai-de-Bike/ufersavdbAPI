...
function getCountAllLogs(req, res, next) {
  return db
    .func("getCountAllLogs", undefined, queryResult.one)
    .then(function(data) {
      res
        .status(200)
...
function getAllLogs(req, res, next) {
  return db
    .func("getvdbLogs", undefined, queryResult.any)
    .then(function(data) {
      res
        .status(200)
...
function getLogBk(req, res, next) {
  ...
  return db
    .func("getvdbLogsBk", bkID, queryResult.any)
    .then(function(data) {
      res
        .status(200)
...
function getLogSt(req, res, next) {
  ...
  return db
    .func("getvdbLogsSt", stID, queryResult.any)
    .then(function(data) {
      res
        .status(200)
...
function getLogCli(req, res, next) {
  ...
  return db
    .func("getvdbLogsCli", userID, queryResult.any)
    .then(function(data) {
      res
        .status(200)
...
function getBikeOfCli(req, res, next) {
  const bkId = parseInt(req.params.id);
  return db
    .func("getBikeOfCli", bkId, queryResult.one)
    .then(function(data) {
      res
        .status(200)
...
function getCountSt(req, res, next) {
  return db
    .func("getCountAllLogsSt", parseInt(req.params.id), queryResult.one)
    .then(function(data) {
      res
        .status(200)
        .json(
          response.success(
            data,
            "Retornou o total de transações de uma estação"
          )
        );
    })
    .catch(function(err) {
...
function getCountBk(req, res, next) {
  return db
    .func("getCountAllLogsBk", parseInt(req.params.id), queryResult.one)
    .then(function(data) {
      res
        .status(200)
        .json(
          response.success(
            data,
            "Retornou o total de transações de uma bicicleta"
          )
        );
    })
    .catch(function(err) {
...
function getCountCli(req, res, next) {
  return db
    .func("getCountAllLogsCli", parseInt(req.params.id), queryResult.one)
    .then(function(data) {
      res
        .status(200)
        .json(
          response.success(data, "Retornou o total de transações de um cliente")
        );
    })
    .catch(function(err) {
      res.status(500).json(response.failure(err));
...
function doLoan(req, res, next) {
  return db
    ...
    .then(function() {
      res.status(200).json(response.success({}, "Uma bike foi entregue"));
    })
    .catch(function(err) {
      res.status(500).json(response.failure(err));
    });
