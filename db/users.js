    ...
    .then(function(data) {
      res
        ...
        .json(
          response.success(
            data,
            "Login de usuario " + req.body.username + " efetuado"
          )
        );
    })
    .catch(function(err) {
...
function signup(req, res, next) {
  return db
    ...
    .then(function() {
      res.status(200).json(response.success({}, "Um usuário cadastrado"));
    })
    .catch(function(err) {
...
function getUsers(req, res, next) {
  return db
    .func("getClients", undefined, queryResult.many)
    .then(function(data) {
      res
        .status(200)
...
function getValUsers(req, res, next) {
  return db
    .func("getValCli", undefined, queryResult.many)
    .then(function(data) {
      res
        .status(200)
        .json(
          response.success(data, "Retornou o id e nome de usuários válidos")
        );
    })
    .catch(function(err) {
      res.status(500).json(response.failure(err));
...
function getUserNames(req, res, next) {
  return db
    .func("getClientsUserName", undefined, queryResult.many)
    .then(function(data) {
      res
        .status(200)
...
function getUser(req, res, next) {
  ...
  return db
    .func("getClient", userID, queryResult.one)
    .then(function(data) {
      res.status(200).json(response.success(data, "Retornou um usuário"));
    })
    .catch(function(err) {
      res.status(500).json(response.failure(err));
    });
...
function getInfos(req, res, next) {
  return db
    .func("getInfosCli", undefined, queryResult.many)
    .then(function(data) {
      res
        .status(200)
        .json(
          response.success(data, "Retornou as informações de todos os usuários")
        );
    })
    .catch(function(err) {
      res.status(500).json(response.failure(err));
...
function getInfo(req, res, next) {
  const userID = parseInt(req.params.id);
  return db
    .func("getInfoCli", userID, queryResult.one)
    .then(function(data) {
      res
        .status(200)
...
function getLogs(req, res, next) {
  return db
    .func("getHistsCli", null, queryResult.many)
    .then(function(data) {
      res
        .status(200)
        .json(
          response.success(data, "Retornou o histórico de todos os usuários")
        );
    })
    .catch(function(err) {
      res.status(500).json(response.failure(err));
...
function getLog(req, res, next) {
  const userID = parseInt(req.params.id);
  return db
    .func("getHistCli", [userID, null], queryResult.many)
    .then(function(data) {
      res
        .status(200)
...
function createUser(req, res, next) {
  return db
    .func(
      "createClient",
      [parseInt(req.body.role), req.body.username, req.body.password],
      queryResult.one
    )
    .then(function() {
      res.status(200).json(response.success({}, "Um usuário inserido"));
    })
    .catch(function(err) {
      res.status(500).json(response.failure(err));
    });
...
function updateUser(req, res, next) {
  ...
  return db
    ...
    .then(function() {
      res.status(200).json(response.success({}, "Atualizou um usuário"));
    })
    .catch(function(err) {
      res.status(500).json(response.failure(err));
    });
...
function removeUser(req, res, next) {
  const userID = parseInt(req.params.id);
  return db
    .func("delClient", userID, queryResult.one)
    .then(function(result) {
      res.status(200).json(response.success({}, "Removeu um usuário"));
    })
    .catch(function(err) {
      res.status(500).json(response.failure(err));
    });
...
function removeUsers(req, res, next) {
  return db
    .func("delClients", undefined, queryResult.one)
    .then(function(result) {
      res
        .status(200)
...
function changeSit(req, res, next) {
  const userID = parseInt(req.params.id);
  return db
    .func("changeSit", userID, queryResult.one)
    .then(function(result) {
      res
        .status(200)
